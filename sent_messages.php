...
<body>
    <div>
        <table id="table" class="message_table">
            <?php $result = sent_conversations($_SESSION["username"]) ?>
            <?php while ($row = $result->fetch_assoc()): ?>
                <tr onclick=openMessage(this)>
                    <td class="name"> <?php echo $row["receiver"] ?></td>
        ...
        <form action="message_view.php" method="post" id="view_message">
